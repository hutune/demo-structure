...
import (
	"fmt"
	"rmn-backend/services/user-service/internal/app/routes"
	"rmn-backend/services/user-service/internal/common"
	exampleLogic "rmn-backend/services/user-service/internal/logic/example"
	"rmn-backend/services/user-service/internal/repositories"
	"rmn-backend/services/user-service/internal/services"
)
