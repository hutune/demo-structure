...
import (
	...
	"rmn-backend/services/user-service/internal/dto"
	"rmn-backend/services/user-service/internal/models"
...
func NewExampleHandler(logger *logger.ZeroLogger) *ExampleHandler {
